        ...
        <div class = "row">
            ...
            <form method = "post" action = "php/functions.php">
                  <div class = "input-group mb-3">
                    ...
                    <input type = "text" class = "form-control" name = "us_sn" placeholder = "Owner's shop">
                </div>
                <div class = "input-group mb-3">
                    <legend>Shop owner's name</legend>
                    <input type = "text" class = "form-control" name = "us_fn" placeholder = "Fullname">
                </div>
                <div class = "input-group mb-3">
                    <legend>Shop address</legend>
                    <input type = "text" class = "form-control" name = "us_address" placeholder = "Street">
                </div>
                <div class = "input-group mb-3">
                    <legend>Email</legend>
                    <input type = "text" class = "form-control" name = "us_email" placeholder = "Email">
                </div>
            </div>
